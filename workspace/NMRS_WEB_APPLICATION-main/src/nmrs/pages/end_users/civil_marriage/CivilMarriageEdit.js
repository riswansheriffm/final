...
export default function CivilMarriageEdit({ id, setModal, editWithKey }) {
  ...
  const handleSave = () => {
    if (step === 1) {
      ...
      } else if (!detail1.gName) {
        toast.error(`Please Enter Groom Name `, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bName) {
        toast.error(`Please Enter Bride Name `, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gNumber) {
        toast.error(`Please Enter Groom Mobile Number`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!mobileNumRegex.test(detail1.gNumber)) {
        toast.error(`Groom's Mobile Number Is Invalid`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bNumber) {
        toast.error(`Please Enter Bride Mobile Number`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!mobileNumRegex.test(detail1.bNumber)) {
        toast.error(`Bride's Mobile Number Is Invalid`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.gNumber === detail1.bNumber) {
        toast.error(
          `Groom Mobile Number And Bride Mobile Number Must Not Be Same`,
          {
            theme: "colored",
            toastId: "error-toast",
          }
        );
      } else if (!detail1.gDob) {
        toast.error(`Please Enter Groom Date Of Birth`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bDob) {
        toast.error(`Please Enter Bride Date Of Birth`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gMaritalStatus) {
        toast.error(`Please Select Groom's Marital Status`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bMaritalStatus) {
        toast.error(`Please Select Bride's Marital Status`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gNationality) {
        toast.error(`Please Select Groom's Nationality`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bNationality) {
        toast.error(`Please Select Bride's Nationality`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gAddress) {
        toast.error(`Please Enter Groom's Residence`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bAddress) {
        toast.error(`Please Enter Bride's Residence`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gOccupation) {
        toast.error(`Please Enter Groom's Occupation`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bOccupation) {
        toast.error(`Please Enter Bride's Occupation`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else {
      ...
      if (
      ...
      } else if (!detail1.gFather) {
        toast.error(`Please Enter Groom's Father Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bFather) {
        toast.error(`Please Enter Bride's Father Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gFatherOccupation) {
        toast.error(`Please Enter Groom's Father Occupation`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bFatherOccupation) {
        toast.error(`Please Enter Bride's Father Occupation`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.witness1) {
        toast.error(`Please Enter witness 1 Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.witness2) {
        toast.error(`Please Enter witness 2 Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.doMarriage) {
        toast.error(`Please Enter Date Of Marriage`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.celebrant) {
        toast.error(`Please Enter Celebrant Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.poMarriage) {
        toast.error(`Please Select Place Of Marriage`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Select Registrar Office Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.poMarriage === "Church" && !detail1.noChurch) {
        toast.error(`Please Select Church Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.poMarriage === "Temple" && !detail1.noTemple) {
        toast.error(`Please Select Temple Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.poMarriage === "Mosque" && !detail1.noMosque) {
        toast.error(`Please Select Mosque Name`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.county) {
        toast.error(`Please Select County`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.district) {
        toast.error(`Please Select District`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.zipCode) {
    ...
    if (step === 3) {
      if (
        ...
        toast.error(`Please Attach Groom's National Id`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Attach Bride's National Id`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.gNationality === "Ugandan" && !detail1.gLC1) {
        toast.error(`Please Attach Groom's LC1 Certificate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.bNationality === "Ugandan" && !detail1.bLC1) {
        toast.error(`Please Attach Bride's  LC1 Certificate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.gPhoto) {
        toast.error(`Please Attach Groom's Passport Size Photo`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.bPhoto) {
        toast.error(`Please Attach Bride's Passport Size Photo`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.w1Id) {
        toast.error(`Please Attach Witness 1 Id Proof`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.w2Id) {
        toast.error(`Please Attach Witness 2 Id Proof`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.gMaritalStatus === "Divorced" && !detail1.gDDA) {
        toast.error(`Please Attach Groom's Divorce Decree Associate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.bMaritalStatus === "Divorced" && !detail1.bDDA) {
        toast.error(`Please Attach Bride's Divorce Decree Associate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.gMaritalStatus === "Widower" && !detail1.gWDC) {
        toast.error(`Please Attach Groom's Wife Death Certificate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (detail1.bMaritalStatus === "Widow" && !detail1.bHDC) {
        toast.error(`Please Attach Bride's Husband Death Certificate`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Attach Groom's Single Status Letter`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Attach Bride's Single Status Letter`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Attach Groom's Visa`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (
        ...
        toast.error(`Please Attach Bride's Visa`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else if (!detail1.rmAffidavits) {
        toast.error(`Please Attach Registered Marriage Affidavits`, {
          theme: "colored",
          toastId: "error-toast",
        });
      } else {
  ...
  const handleNext = (e) => {
    ...
    if (step === 1) {
      ...
      } else if (!mobileNumRegex.test(details.gNumber)) {
      ...
      } else if (!mobileNumRegex.test(details.bNumber)) {
        filled.current.one = false;
      ...
      } else if (details.gNumber === details.bNumber) {
        filled.current.one = false;
