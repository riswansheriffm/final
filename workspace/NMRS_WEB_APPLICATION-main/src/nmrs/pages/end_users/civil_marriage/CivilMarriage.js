...
export default function CivilMarriage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (details.gNationality === "Ugandan") {
      if (details.gMaritalStatus === "Single" || details.gWDC || details.gDDA) {
    ...
    if (details.bNationality === "Ugandan") {
      if (details.bMaritalStatus === "Single" || details.bHDC || details.bDDA) {
        if (
          details.bLC1 &&
          details.bPhoto &&
          details.bId &&
              ...
              {step === 2 && (
                <>
                  ...
                  <TextInput
                    ...
                    labelText="Groom Father's Occupation"
                    onChange={handleChange}
                  ...
                  <TextInput
                    ...
                    labelText="Bride Father's Occupation"
                    onChange={handleChange}
